<template>
    ...
    <aside
        ...
        <aside class="flex flex-col h-full w-full bg-white">
            <Menu :isSidebarOpen="isSidebarOpen" :config="props.config" :user="props.user" :workspace="props.workspace" :organizations="props.workspaces" @closeSidebar="closeSidebar()"></Menu>
        </aside>
    </aside>
