            ...
            <div class="min-h-screen flex flex-col w-full min-w-0 items-center justify-center space-x-4">
                <div class="bg-white rounded-xl p-5 border">
                    ...
                    <div class="min-w-[300px] border-t pt-4 space-y-4">
                        <div v-for="(item, index) in props.workspaces" :key="index" @click="selectWorkspace(item.workspace.uuid)" class="flex space-x-8 bg-white rounded-md px-4 py-2 justify-between items-center w-full hover:shadow-md cursor-pointer">
