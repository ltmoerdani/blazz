<template>
    <aside class="md:flex flex-col h-full w-80 bg-white hidden">
        <Menu :config="props.config" :user="props.user" :workspace="props.workspace" :organizations="props.workspaces"></Menu>
    </aside>
   <!--<aside class="md:flex flex-col h-full w-80 bg-white hidden">
        ...
        <div class="flex-grow space-y-3 px-2 overflow-y-scroll">
            <div class="flex-1">
                <ul class="pt-2 space-y-1 text-sm pb-4">
                    ...
                    <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2" :class="$page.url.startsWith('/admin/workspace') ? 'bg-slate-50 text-black' : ''">
